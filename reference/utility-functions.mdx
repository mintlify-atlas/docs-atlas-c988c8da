...
<ParamField path="params" type="SameChainSwapInput" required>
  ...
  <ParamField path="tokenIn" type="string" required>
    Input token address
  </ParamField>
  
  <ParamField path="tokenInAmount" type="string" required>
    Amount to swap in token's smallest unit
  </ParamField>
  
  <ParamField path="tokenOut" type="string" required>
    Output token address
  </ParamField>
  
  <ParamField path="tokenOutRecipient" type="string" required>
    Recipient address
  </ParamField>
  ...
  <ParamField path="srcChainPriorityLevel" type="string">
    Priority level: "normal" or "high" (default: "normal")
  </ParamField>
  
  <ParamField path="slippage" type="string">
...
**Location:** `src/utils/deBridge/sameChainSwap.ts:4`
...
<ParamField path="params" type="SameChainSwapEstimateInput" required>
...
**Location:** `src/utils/deBridge/sameChainSwapEstimate.ts:4`

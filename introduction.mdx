...
<CardGroup cols={2}>
  ...
  <Card title="Smart hooks" icon="webhook" href="#">
    Execute custom logic on the destination chain, like supplying to Aave or staking
  </Card>
  
  <Card title="Affiliate program" icon="money-bill-trend-up" href="#">
    Earn fees on every transaction by integrating deBridge into your platform
  </Card>
  
  <Card title="Order management" icon="magnifying-glass-chart" href="#">
